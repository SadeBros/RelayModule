...
public:
    ...
    bool activate(uint8_t relayNumber);         //  Activates the specified relay in the "Relays" array.
    bool activateAll();                         //  Activates all the relays in the "Relays" array.

    bool deactivate(uint8_t relayNumber);       //  Deactivates the specified relay in the "Relays" array.
    bool deactivateAll();                       //  Deactivates all the relays in the "Relays" array.
